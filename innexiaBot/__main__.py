...
PM_START_TEXT = """
`Heya` 🤗 `I am` **Mr.Dumper** `your group super bot`
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🔥 Owner", url=f"t.me/anonymoustechnician"),
        InlineKeyboardButton(
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/DumperChat")]]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bugs", url="t.me/DumperChat"
                        ),
                        InlineKeyboardButton(
                            text="Creator", url="t.me/DevilTheCoder"
                        ),
                    ],
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Fᴇᴅ", url="t.me/DumperChat"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/DumperChat"),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Anonymous", url="t.me/AnonymousTechnician"),
                 ],
                 [
